...
//    
//    while(hdma_usart10_rx.Instance->CR & DMA_SxCR_EN)
//    {
//        __HAL_DMA_DISABLE(&hdma_usart10_rx);
//    }
...
//    hdma_usart10_rx.Instance->PAR = (uint32_t) & (USART6->DR);
//    //memory buffer 1
//    //内存缓冲区1
//    hdma_usart10_rx.Instance->M0AR = (uint32_t)(rx1_buf);
//    //memory buffer 2
//    //内存缓冲区2
//    hdma_usart10_rx.Instance->M1AR = (uint32_t)(rx2_buf);
//    //data length
//    //数据长度
...
//    //使能双缓冲区
//    SET_BIT(hdma_usart10_rx.Instance->CR, DMA_SxCR_DBM);
...
//    while(hdma_usart10_tx.Instance->CR & DMA_SxCR_EN)
//    {
//        __HAL_DMA_DISABLE(&hdma_usart10_tx);
//    }

//    hdma_usart10_tx.Instance->PAR = (uint32_t) & (USART6->DR);
...
//    hdma_usart10_tx.Instance->M0AR = (uint32_t)(data);
